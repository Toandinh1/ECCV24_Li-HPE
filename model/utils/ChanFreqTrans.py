...
class Reconstruct(nn.Module):
    def __init__(self, in_channels, out_channels, img_size, kernel_size, scale_factor):
...
class ChannelTransformer(nn.Module):
    def __init__(self, vis, img_size, channel_num, num_layers, num_heads):
        ...
        self.reconstruct_1 = Reconstruct(channel_num, channel_num, img_size, kernel_size=1,scale_factor=(1,1))
